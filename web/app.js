...
const translations = {
  ...
  fr: {
    ...
    galFilterAll: "Toutes", galFilterExt: "Extérieur", galFilterInt: "Intérieurs", galFilterNight: "Piscine & Nuit", galFilterCommon: "Espaces Communs", galFilterBeach: "Plage & Mer", galFilterNabeul: "Nabeul & Ville",
    ...
    qCard2Title: "Nabeul & Artisanat", qCard2Desc: "Capitale tunisienne de la céramique, jarre monumentale et ateliers d'art.",
    qCard3Title: "Souk & Marchés de Nabeul", qCard3Desc: "Allées piétonnes bordées de palmiers, poteries traditionnelles, tapis et animation authentique.",
    qCard4Title: "Médina & Ruelles Historiques", qCard4Desc: "Maroquinerie fine, ruelles blanches et bleues, minarets et trésors du patrimoine tunisien.",
  ...
  en: {
    ...
    galFilterAll: "All", galFilterExt: "Exterior", galFilterInt: "Interiors", galFilterNight: "Pool & Night", galFilterCommon: "Common Areas", galFilterBeach: "Beach & Sea", galFilterNabeul: "Nabeul & City",
  ...
  ar: {
    ...
    galFilterAll: "الكل", galFilterExt: "الخارج", galFilterInt: "التصميم الداخلي", galFilterNight: "المسبح وليلاً", galFilterCommon: "المساحات المشتركة", galFilterBeach: "الشاطئ والبحر", galFilterNabeul: "نابل والمدينة",
    ...
    qCard2Title: "نابل والصناعات التقليدية", qCard2Desc: "عاصمة الخزف والفخار التونسي، الجرة التذكارية ومشاغل الفنون الأصيلة.",
    qCard3Title: "أسواق نابل وسوق الجمعة", qCard3Desc: "أروقة مخصصة للمشاة محاطة بأشجار النخيل، فخار تقليدي ومصنوعات تراثية.",
    qCard4Title: "المدينة العتيقة والأزقة التاريخية", qCard4Desc: "مصنوعات جلدية راقية، جدران بيضاء بنوافذ زرقاء وتراث تونسي أصيل.",
  ...
  es: {
    ...
    galFilterAll: "Todas", galFilterExt: "Exterior", galFilterInt: "Interiores", galFilterNight: "Piscina y Noche", galFilterCommon: "Zonas Comunes", galFilterBeach: "Playa y Mar", galFilterNabeul: "Nabeul y Ciudad",
    ...
    qCard2Title: "Nabeul y Artesanía", qCard2Desc: "Capital tunecina de la cerámica, jarra monumental y talleres de arte.",
    qCard3Title: "Zocos y Mercados de Nabeul", qCard3Desc: "Avenida peatonal de palmeras, cerámica tradicional, alfombras y ambiente auténtico.",
    qCard4Title: "Medina y Calles Históricas", qCard4Desc: "Marroquinería de cuero, callejuelas blancas y azules, minaretes y patrimonio histórico.",
  ...
  it: {
    ...
    galFilterAll: "Tutte", galFilterExt: "Esterno", galFilterInt: "Interni", galFilterNight: "Piscina & Notte", galFilterCommon: "Spazi Comuni", galFilterBeach: "Spiaggia e Mare", galFilterNabeul: "Nabeul & Città",
  ...
  de: {
    ...
    galFilterAll: "Alle", galFilterExt: "Außenbereich", galFilterInt: "Innenräume", galFilterNight: "Pool & Nacht", galFilterCommon: "Gemeinschaftsbereiche", galFilterBeach: "Strand & Meer", galFilterNabeul: "Nabeul & Stadt",
    ...
    qCard3Title: "Souks & Märkte von Nabeul", qCard3Desc: "Palmenpromenade für Fußgänger, traditionelle Keramik, Teppiche und authentische Atmosphäre.",
    qCard4Title: "Medina & Historische Gassen", qCard4Desc: "Feine Lederwaren, weiß-blaue Gassen, Minarette und reiches tunesisches Kulturerbe.",
...
function applyTranslation(lang) {
  ...
  const textIds = [
    ...
    'galFilterAll','galFilterExt','galFilterInt','galFilterNight','galFilterCommon','galFilterBeach','galFilterNabeul',
